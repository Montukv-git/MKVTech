# Project: MKVTech (Vite + React + Tailwind + Framer Motion)
# Repo: https://github.com/Montukv-git/MKVTech
...
# ─────────────────────────────────────────────────────────────
# 2) vite.config.ts  (IMPORTANT: base path for GitHub Pages)
# ─────────────────────────────────────────────────────────────
import { defineConfig } from 'vite'
import react from '@vitejs/plugin-react'

// If the repo is https://github.com/Montukv-git/MKVTech
// the project page will be served at https://montukv-git.github.io/MKVTech/
// so base must be "/MKVTech/"
...
<html lang="en">
  <head>
    ...
    <title>Montukeshwar Vaishnaw • MKVTech</title>
  </head>
...
# ─────────────────────────────────────────────────────────────
# 8) src/App.tsx  (thin wrapper to render your Portfolio component)
# ─────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────
# 9) src/Portfolio.tsx  (YOUR FULL PORTFOLIO COMPONENT)
#    This is the working version with animations, sections, form, etc.
# ─────────────────────────────────────────────────────────────
...
export default function Portfolio() {
  ...
  const socials = {
    ...
    email: "mailto:hello@example.com?subject=Hi%20Montukeshwar!",
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10">
        <div className="rounded-2xl border border-neutral-800 bg-gradient-to-br from-neutral-900/60 to-neutral-900/20 p-8 text-center">
          ...
          <div className="mt-4 flex items-center justify-center gap-3">
            <a href="#contact" onClick={(e)=>{e.preventDefault();scrollTo('contact')}} className="rounded-xl px-5 py-3 bg-white text-neutral-900 font-medium">Book an intro</a>
      ...
      <section id="contact" className="mx-auto max-w-6xl px-4 py-20 border-t border-neutral-900/60">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6">
          <motion.form variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} onSubmit={(e) => { e.preventDefault(); window.location.href = socials.email; }} className="rounded-2xl border border-neutral-800 p-6 bg-neutral-900/30">
            ...
            <textarea rows={5} className="mt-1 w-full rounded-xl bg-neutral-900 border border-neutral-800 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-neutral-600" placeholder="Tell me about your project…" />
          ...
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="rounded-2xl border border-neutral-800 p-6 bg-neutral-900/30">
            ...
            <ul className="mt-4 space-y-2 text-neutral-300">
              ...
              <li><a className="hover:text-white" href={socials.linkedin} target="_blank">LinkedIn</a></li>
      ...
      <footer className="border-t border-neutral-900/60 py-10">
        <div className="mx-auto max-w-6xl px-4 text-sm text-neutral-500 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex gap-4">
            <a className="hover:text-neutral-300" href="#about" onClick={(e)=>{e.preventDefault();scrollTo('about')}}>About</a>
            <a className="hover:text-neutral-300" href="#work" onClick={(e)=>{e.preventDefault();scrollTo('work')}}>Work</a>
            <a className="hover:text-neutral-300" href="#contact" onClick={(e)=>{e.preventDefault();scrollTo('contact')}}>Contact</a>
          </div>
        </div>
      </footer>
    </main>
...
# ─────────────────────────────────────────────────────────────
# 10) .github/workflows/deploy.yml  (GitHub Pages via Actions)
# ─────────────────────────────────────────────────────────────
...
- Project URL: `https://montukv-git.github.io/MKVTech/`

## Notes
- Update social links in `src/Portfolio.tsx`.
- Put your PDF resume at `public/resume.pdf` (create `public/` folder if missing).
